...
helm install 02.homepage导航 jameswynn/02.homepage导航 -f values.yaml
```
...
ingress:
    main:
        ...
        annotations:
            ...
            gethomepage.dev/icon: "02.homepage导航.png"
        hosts:
            - host: 02.homepage导航.example.com
              paths:
                  - path: /
                    pathType: Prefix
```
...
metadata:
    ...
    namespace: default
    labels:
        app.kubernetes.io/name: 02.homepage导航
secrets:
    - name: 02.homepage导航
```
...
metadata:
    ...
    labels:
        app.kubernetes.io/name: 02.homepage导航
    annotations:
        kubernetes.io/service-account.name: 02.homepage导航
```
    ...
    template:
        metadata:
            labels:
                app.kubernetes.io/name: 02.homepage导航
        spec:
            serviceAccountName: 02.homepage导航
