...
进入docker，点击镜像管理-本地镜像-添加-私有库（注意是私有库，这个镜像未发布在Docker Hub），URL地址处输入：ghcr.io/benphelps/homepage:latest，下载最新版镜像。

![img](./img/0101.png)

### 创建容器

1、安装教程：<https://gethomepage.dev/v0.7.3/installation/docker/>
