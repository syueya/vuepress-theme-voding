...
从 v0.7.2 开始，homepage从 benphelps/homepage 迁移到位于 gethomepage/homepage 的存储库。

所以安装URL由: ghcr.io/benphelps/homepage:latest 改成：ghcr.io/gethomepage/homepage:latest。
